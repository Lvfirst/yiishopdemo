                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            ...
                            <?=Html::label('管理员名称', null). Html::encode($adminuser);?>
                                </div>
                                <div class='span12 field-box'>
                            <?=Html::label('角色',null).Html::checkboxList('children',(empty($children['roles']) ? [] : $children['roles']),$roles);?>
                                </div>
                            <div class="span12 field-box">
                                <?=Html::label('权限', null). Html::checkboxList('children', (empty($children['permission']) ? [] : $children['permission']),$permissions); ?>
                            </div>
