...
<section id="checkout-page">
    <div class="container">
        <div class="col-xs-12 no-margin">
            <section id="shipping-address" style="margin-bottom:100px;margin-top:-10px">
                <h2 class="border h1">收货地址</h2>
                    ...
                    <div class="row field-row" style="margin-top:10px">
                        <div class="col-xs-12">
                            <input class="le-radio big address" type="radio" name="address" value="<?php echo $address['addressid'] ?>" <?php if ($key == 0) {echo 'checked = "checked"';$defaultval=$address['addressid'];} ?> />
            ...
            <input type="hidden" name="addressid" value='<?=$defaultval;?>'>
                ...
                <div class="col-xs-12 col-lg-4 col-lg-offset-8 no-margin-right">
                    <div id="subtotal-holder">
                        ...
                        <ul id="total-field" class="tabled-data inverse-bold ">
                            <li>
                                <label>订单总额</label>
                                <div class="value" style="width:100%;text-align:right" id="ototal">￥ <span><?php echo $total + 1 ?></span></div>
                            </li>
                        </ul><!-- /.tabled-data -->
