...
<html lang="<?=Yii::$app->language;?>">
	<head>
        ...
        <?php $this->registerMetaTag(['name'=>'description','content'=>'好好学习']);?>
        <?php $this->registerMetaTag(['name'=>'author','content'=>'lvzhiwei']);?>
...
<div class="search-area">
    <?php $form=ActiveForm::begin(
        ...
        <div class="control-group">
            <input class="search-field" name='keywords' placeholder="Search for item" />
...
<!-- ============================================================= FOOTER : END ============================================================= -->	</div><!-- /.wrapper -->
  ...
  <!--   <script src="/assets/js/jquery-1.10.2.min.js"></script>
    ...
    <script src="http://one.mevlife.com/resource/cdnresource/js/googlemap.js"></script>
